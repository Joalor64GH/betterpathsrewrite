...
class FlxAnimate extends FlxSymbol
{
	...
	{
		@:privateAccess {
			coolParse = Json.parse(Assets.getText(Paths.file('images/tightBars/Animation.json', TEXT, null)));
			coolParse.AN.TL.L.reverse();
			super(x, y, coolParse);
			frames = fromAnimate(Paths.file('images/tightBars/spritemap1.png', TEXT, null), Paths.file('images/tightBars/spritemap1.json', TEXT, null));
		}
	}
